function get_orbit_info_low(sides) {
    ...
    return {L:L,A:A,r:r,R:R,rR:safe_div(r,R),cotw:cotw,l2:l2,linv:linv,l2inv:l2inv,cosprod:cosprod,lprod:lprod};
 }
 
 function get_info_arr(info,info_der,not_ref) {
    const basics =  [info.L, info.A, info.r, info.R, info.rR,
       info.cotw, info.l2, info.linv, info.l2inv, info.cosprod,info.lprod];
    return not_ref?
    basics.concat([info_der.L, info_der.A, info_der.r, info_der.R, info_der.rR,
       info_der.cotw, info_der.l2, info_der.linv, info_der.l2inv, info_der.cosprod,info_der.lprod,
    // ["L'/L", "A'/A", "A'.A"]
