        ...
        <div style="display: inline-flex;margin-left:1px;margin-right:1px;">
            <div class="circ">
                <select id="circ`+xn_number+`">
                    ...
                    <option value="apollonius_isodyns">apollon123</option>
                    ...
                    <option value="mixtilinears">mixt123</option>
                    <option value="mixtilinear1_exc">mixt exc1</option>
                    <option value="mixtilinear2_exc">mixt exc2</option>
                    <option value="mixtilinear3_exc">mixt exc3</option>
                    <option value="mixtilinear_excs">mixt exc123</option>
