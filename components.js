...
<div class="component xn_selector">
    ...
    <div class="input_Xn">
        ...
        <select class='tri_type' id="tri_type_`+xn_number+`" name="tri_type_`+xn_number+`">
            ...
            <option value="circumperp1">circumperp1</option>
            <option value="circumperp2">circumperp2</option>
            <option value="exc_inc_refl">exc-inc-refl</option>
            <option value="exc_midpoint">exc-midpoint</option>
            ...
            <option value="mandart_exc">mandart-exc</option>
            <option value="mandart_inc">mandart-inc</option>
            <option value="ursa_major">ursa-major</option>
            <option value="ursa_minor">ursa-minor</option>
            <option value="x3_abc_refl">x3-abc-refl</option>
        </select>
