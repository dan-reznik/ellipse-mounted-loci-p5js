...
<div class="component xn_selector">
    ...
    <div class="input_Xn">
        ...
        <select class='tri_type' id="tri_type_`+xn_number+`" name="tri_type_`+xn_number+`">
            ...
            <option value="bitang_ext">.bitangCext</option>
            <option value="bitang_ext_cont">.bitangCextT</option>
            <option value="bitang_int">.bitangCint</option>
            <option value="bitang_int_cont">.bitangCintT</option>
            <option value="bitang_inc_ext">.bitangIext</option>
            <option value="bitang_inc_ext_cont">.bitangIextT</option>
            <option value="bitang_inc_int">.bitangIint</option>
            <option value="bitang_inc_int_cont">.bitangIintT</option>
