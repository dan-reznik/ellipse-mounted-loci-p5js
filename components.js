...
<div class="component xn_selector">
    ...
    <div class="input_Xn">
        ...
        <select class='tri_type' id="tri_type_`+xn_number+`" name="tri_type_`+xn_number+`">
            ...
            <option value="bitang_ext_cont">.bitangCext#</option>
            <option value="bitang_int_cont">.bitangCint#</option>
            <option value="bitang_inc_ext">.bitangIext</option>
            <option value="bitang_inc_int">.bitangIint</option>
            <option value="bitang_inc_ext_cont">.bitangIext#</option>
            <option value="bitang_inc_int_cont">.bitangIint#</option>
