...
<div class="component xn_selector">
    ...
    <div class="input_Xn">
        ...
        <select class='cpn' id="cpn_`+xn_number+`" name="cpn_`+xn_number+`">
            ...
            <option value="subtri_x4">subtri-x4</option>
            <option value="subtri_x5">subtri-x5</option>
            <option value="subtri_x6">subtri-x6</option>
            <option value="subtri_x7">subtri-x7</option>
            <option value="subtri_x8">subtri-x8</option>
            <option value="subtri_x9">subtri-x9</option>
            <option value="subtri_x10">subtri-x10</option>
            <option value="subtri_x11">subtri-x11</option>
            </select>
